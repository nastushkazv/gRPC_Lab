...
public final class OrderServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.example.OrderService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.example.orderservice.CreateOrderRequest,
      com.example.orderservice.OrderResponse> getCreateOrderMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateOrder",
      requestType = com.example.orderservice.CreateOrderRequest.class,
      responseType = com.example.orderservice.OrderResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.orderservice.CreateOrderRequest,
      com.example.orderservice.OrderResponse> getCreateOrderMethod() {
    io.grpc.MethodDescriptor<com.example.orderservice.CreateOrderRequest, com.example.orderservice.OrderResponse> getCreateOrderMethod;
      ...
      synchronized (OrderServiceGrpc.class) {
        if ((getCreateOrderMethod = OrderServiceGrpc.getCreateOrderMethod) == null) {
          OrderServiceGrpc.getCreateOrderMethod = getCreateOrderMethod =
              io.grpc.MethodDescriptor.<com.example.orderservice.CreateOrderRequest, com.example.orderservice.OrderResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateOrder"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.orderservice.CreateOrderRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.orderservice.OrderResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.orderservice.GetOrderRequest,
      com.example.orderservice.OrderResponse> getGetOrderMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetOrder",
      requestType = com.example.orderservice.GetOrderRequest.class,
      responseType = com.example.orderservice.OrderResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.orderservice.GetOrderRequest,
      com.example.orderservice.OrderResponse> getGetOrderMethod() {
    io.grpc.MethodDescriptor<com.example.orderservice.GetOrderRequest, com.example.orderservice.OrderResponse> getGetOrderMethod;
    if ((getGetOrderMethod = OrderServiceGrpc.getGetOrderMethod) == null) {
      synchronized (OrderServiceGrpc.class) {
        if ((getGetOrderMethod = OrderServiceGrpc.getGetOrderMethod) == null) {
          OrderServiceGrpc.getGetOrderMethod = getGetOrderMethod =
              io.grpc.MethodDescriptor.<com.example.orderservice.GetOrderRequest, com.example.orderservice.OrderResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetOrder"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.orderservice.GetOrderRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.orderservice.OrderResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void createOrder(com.example.orderservice.CreateOrderRequest request,
        io.grpc.stub.StreamObserver<com.example.orderservice.OrderResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCreateOrderMethod(), responseObserver);
    }

    /**
     */
    default void getOrder(com.example.orderservice.GetOrderRequest request,
        io.grpc.stub.StreamObserver<com.example.orderservice.OrderResponse> responseObserver) {
  ...
  public static final class OrderServiceStub
    ...
    /**
     */
    public void createOrder(com.example.orderservice.CreateOrderRequest request,
        io.grpc.stub.StreamObserver<com.example.orderservice.OrderResponse> responseObserver) {
    ...
    /**
     */
    public void getOrder(com.example.orderservice.GetOrderRequest request,
        io.grpc.stub.StreamObserver<com.example.orderservice.OrderResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class OrderServiceBlockingStub
    ...
    /**
     */
    public com.example.orderservice.OrderResponse createOrder(com.example.orderservice.CreateOrderRequest request) {
    ...
    /**
     */
    public com.example.orderservice.OrderResponse getOrder(com.example.orderservice.GetOrderRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class OrderServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.orderservice.OrderResponse> createOrder(
        com.example.orderservice.CreateOrderRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.orderservice.OrderResponse> getOrder(
        com.example.orderservice.GetOrderRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_ORDER:
          serviceImpl.createOrder((com.example.orderservice.CreateOrderRequest) request,
              (io.grpc.stub.StreamObserver<com.example.orderservice.OrderResponse>) responseObserver);
          break;
        case METHODID_GET_ORDER:
          serviceImpl.getOrder((com.example.orderservice.GetOrderRequest) request,
              (io.grpc.stub.StreamObserver<com.example.orderservice.OrderResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.orderservice.CreateOrderRequest,
              com.example.orderservice.OrderResponse>(
                service, METHODID_CREATE_ORDER)))
        .addMethod(
          getGetOrderMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.orderservice.GetOrderRequest,
              com.example.orderservice.OrderResponse>(
  ...
  private static abstract class OrderServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.orderservice.OrderServiceProto.getDescriptor();
    }
